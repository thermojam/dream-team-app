        ...
        <Accordion type="single" collapsible className="w-full bg-card rounded-lg p-2 shadow-sm">
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="px-4 pt-2 text-muted-foreground">
              Мы — сплоченная команда энтузиастов, увлеченных созданием современных и удобных веб-приложений. Наш коллективный опыт охватывает весь спектр веб-разработки, от фронтенда до бэкенда. Мы верим в сотрудничество, постоянное обучение и стремимся к совершенству в каждом проекте, за который беремся.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
